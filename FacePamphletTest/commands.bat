copy %1\FacePamphletTester.java %1\work\Assignment7\
copy %1\FacePamphletTest.java %1\work\Assignment7\
copy %1\FacePamphletCanvasTest.java %1\work\Assignment7\
copy %1\FacePamphletProfileTest.java %1\work\Assignment7\
copy %1\FacePamphletDatabaseTest.java %1\work\Assignment7\
copy %1\junit-4.12.jar %1\work\Assignment7\
copy %1\hamcrest-core-1.3.jar %1\work\Assignment7\
cd work
cd Assignment7
